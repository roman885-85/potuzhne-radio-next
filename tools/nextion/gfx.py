...
def icon(cv, name, cx, cy, c, bg, k=1.0):
    ...
    if name == 'BACK': L(3, -6, -3, 0, 2.3); L(-3, 0, 3, 6, 2.3)
        ...
        A(-3, 1, 5, 1.9, 200, 40); A(3, 1, 5, 1.9, 320, 160)
        L(-6, -7.5, -8, -9.5, 1.6); L(0, -8.5, 0, -11, 1.6); L(6, -7.5, 8, -9.5, 1.6)
    elif name == 'EYE': A(0, 8, 11, 1.8, -48, 48); A(0, -8, 11, 1.8, 132, 228); O(0, 0, 2.8)
    elif name == 'LED':
        O(0, -1, 5); L(-3, 6.5, 3, 6.5, 1.8); L(-9, -1, -7, -1, 1.6); L(7, -1, 9, -1, 1.6); L(0, -9, 0, -7.5, 1.6)
    elif name == 'ROOM':
        P([(-9, -1), (0, -9), (9, -1), (9, 8), (-9, 8)])
        Lb(-4, 4, -4, 1, 1.5); Lb(0, 4, 0, -1, 1.5); Lb(4, 4, 4, 2, 1.5)
    elif name == 'STOP': B(-6, -6, 12, 12, 2)
    elif name == 'PENCIL': L(-4, 4, 6, -6, 4.2); P([(-8.5, 8.5), (-7, 2), (-2, 7)])
    elif name == 'MIC':
