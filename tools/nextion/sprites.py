...
def pack(keys, width=480, max_h=320, pics=None):
    #  Атлас не робимо вищим за екран: на залізі спрайти з нижньої частини високого атласа
    #  малювались обрізаними (на Mac і в симуляторі — ні). 480×320 — розмір, який дисплей
    #  віддає без сюрпризів; зайвий атлас коштує лише кількох кілобайтів.
