...
$o = & 'C:\Windows\Microsoft.NET\Framework\v3.5\csc.exe' /nologo /platform:x86 /target:winexe /r:System.Core.dll /out:C:\Tools\NextionEditor\NeBuild.exe '\\Mac\Home\Documents\radio_potughne_next\tools\vm\launcher\NeBuild.cs' 2>&1
